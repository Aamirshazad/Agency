...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex h-screen md:flex-row overflow-hidden bg-gradient-to-bl from-[#020308] from-20% via-[#00010a] via-112% to-[#03045e] to-120% text-white font-display">
