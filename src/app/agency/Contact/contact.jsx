...
export default function Contact() {
    ...
    <h2 className="font-display text-base font-semibold ">Our offices</h2>
    <p className="mt-6 text-base text-neutral-400">Prefer doing things in person? We don’t but we have to list our addresses here for legal reasons.</p>
    <ul role="list" className="mt-10 grid grid-cols-1 gap-8 sm:grid-cols-2">
        <li>
            <address className="text-sm not-italic text-neutral-400">
                <strong className="">Copenhagen</strong><br />
                1 Carlsberg Gate<br />
        ...
        <li>
            <address className="text-sm not-italic text-neutral-400">
                <strong className="">Billund</strong><br />
                24 Lego Allé<br />
                7190, Islamabad, Pakistan
            </address>
        </li>
    </ul>
    <div className="mt-16 pt-16 relative before:absolute after:absolute before:bg-red-400 after:bg-green-500 before:left-0 before:top-0 before:h-px before:w-6 after:left-8 after:right-0 after:top-0 after:h-px">
        <h2 className="font-display text-base font-semibold ">Email us</h2>
        <dl className="mt-6 grid grid-cols-1 gap-8 text-sm sm:grid-cols-2">
            <div>
                <dt className="font-semibold text-neutral-950">Careers</dt>
                <dd>
                    <a className="text-neutral-400 hover:text-neutral-950" href="mailto:careerCortex@AI.agency">careers@CortexAI.agency</a>
                </dd>
            </div>
            <div>
                <dt className="font-semibold ">Press</dt>
                <dd>
                    <a className="text-neutral-400 hover:text-neutral-950" href="mailto:press@NexusAI.agency">press@CortexAI.agency</a>
                </dd>
            </div>
        </dl>
    </div>
    <div className="mt-16 pt-16 relative before:absolute after:absolute before:bg-neutral-950 after:bg-neutral-950/10 before:left-0 before:top-0 before:h-px before:w-6 after:left-8 after:right-0 after:top-0 after:h-px">
        <h2 className="font-display text-base font-semibold ">Follow us</h2>
        <ul role="list" className="flex gap-x-10 text-neutral-950 mt-6">
            <li>
                <a aria-label="Facebook" className="transition text-blue-500" href="https://facebook.com">
            ...
            <li>
                <a aria-label="Instagram" className="transition text-red-600" href="https://instagram.com">
                    <svg viewBox="0 0 24 24" aria-hidden="true" className="h-6 w-6 fill-current">
            ...
            <li>
                <a aria-label="GitHub" className="transition  text-netural-900" href="https://github.com">
                    <svg viewBox="0 0 24 24" aria-hidden="true" className="h-6 w-6 fill-current">
            ...
            <li>
                <a aria-label="Dribbble" className="transition text-red-800" href="https://dribbble.com">
                    <svg viewBox="0 0 24 24" aria-hidden="true" className="h-6 w-6 fill-current">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="isolate mt-6 -space-y-px rounded-2xl bg-neutral-400">
                                ...
                                <div className="border border-neutral-300 px-6 py-8 first:rounded-t-2xl last:rounded-b-2xl">
                                    <fieldset>
                                        <legend className="text-base ">Budget</legend>
