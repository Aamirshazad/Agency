...
export default function Contact() {
    ...
    <div className="mt-16 pt-16 relative before:absolute after:absolute before:bg-neutral-950 after:bg-neutral-950/10 before:left-0 before:top-0 before:h-px before:w-6 after:left-8 after:right-0 after:top-0 after:h-px">
        ...
        <dl className="mt-6 grid grid-cols-1 gap-8 text-sm sm:grid-cols-2">
            <div>
                ...
                <dd>
                    <a className="text-neutral-600 hover:text-neutral-950" href="mailto:careers@NexusAI.agency">careers@NexusAI.agency</a>
                </dd>
            </div>
            <div>
                <dt className="font-semibold text-neutral-950">Press</dt>
                <dd>
                    <a className="text-neutral-600 hover:text-neutral-950" href="mailto:press@NexusAI.agency">press@NexusAI.agency</a>
                </dd>
            </div>
        </dl>
    </div>
    <div className="mt-16 pt-16 relative before:absolute after:absolute before:bg-neutral-950 after:bg-neutral-950/10 before:left-0 before:top-0 before:h-px before:w-6 after:left-8 after:right-0 after:top-0 after:h-px">
        ...
        <ul role="list" className="flex gap-x-10 text-neutral-950 mt-6">
            <li>
                <a aria-label="Facebook" className="transition text-blue-700" href="https://facebook.com">
            ...
            <li>
                <a aria-label="Instagram" className="transition text-red-500" href="https://instagram.com">
                    <svg viewBox="0 0 24 24" aria-hidden="true" className="h-6 w-6 fill-current">
            ...
            <li>
                <a aria-label="GitHub" className="transition  text-neutral-900" href="https://github.com">
                    <svg viewBox="0 0 24 24" aria-hidden="true" className="h-6 w-6 fill-current">
            ...
            <li>
                <a aria-label="Dribbble" className="transition text-red-500" href="https://dribbble.com">
                    <svg viewBox="0 0 24 24" aria-hidden="true" className="h-6 w-6 fill-current">
