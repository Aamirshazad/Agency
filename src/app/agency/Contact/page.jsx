                ...
                <div className="grid grid-cols-1 gap-x-8 gap-y-24 lg:grid-cols-2">
                    ...
                    <div>
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mt-6">
                                <button type="submit" className="block w-full rounded-md bg-neutral-950 px-3 py-1.5 text-base font-semibold text-white shadow-sm hover:bg-neutral-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-neutral-950">Submit</button>
                            </div>
                        </form>
                    </div>
